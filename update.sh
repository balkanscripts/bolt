...
#  ╚════╝    ╚═════╝  ╚══════╝   ╚═╝      ╚═╝  ╚═══╝╚══════╝   ╚═╝    ╚══╝╚══╝  ╚═════╝   ╚═╝  ╚═╝
#
#  Product Name : 3.1.0 - BOLT PANEL (Update Suite)
#  Banner       : BOLT PANEL
#  Creator      : vuuletic
#  Repository   : https://github.com/balkanscripts/bolt
# ==============================================================================
...
echo -e "${C_VIBRANT_CYAN}${C_BOLD}  │               Credit: vuuletic  |  3.1.0v - BOLT                           │${C_RESET}"
echo -e "${C_VIBRANT_CYAN}${C_BOLD}  ╰──────────────────────────────────────────────────────────────────────────╯${C_RESET}"
echo ""
...
locate_bolt_directory() {
    ...
    echo -e " ${C_MUTED}[...] Searching system for BOLT Panel directory...${C_RESET}"
    local search_result
